# Generated by Django 2.2 on 2019-05-30 06:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checkbox_poll_answers',
                 models.ManyToManyField(related_name = 'customers', through = 'Tick_server.CheckBoxPollAnswer',
                                        to = 'Tick_server.CheckBoxPoll')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(
                    ...
                    null = True, upload_to = Tick_server.models.upload_to_path)),
            ],
        ),
        migrations.CreateModel(
            name='ShopKind',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('poll',
                 models.OneToOneField(on_delete = django.db.models.deletion.CASCADE, related_name = 'short_answer_poll',
                                      to = 'Tick_server.Poll')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(blank = True, null = True, on_delete = django.db.models.deletion.CASCADE,
                                           related_name = 'users', to = 'Tick_server.City')),
        ...
        migrations.CreateModel(
            ...
            fields = [
                ...
                ('city',
                 models.ForeignKey(null = True, on_delete = django.db.models.deletion.CASCADE, related_name = 'shops',
                                   to = 'Tick_server.City')),
                ('salesman',
                 models.ForeignKey(null = True, on_delete = django.db.models.deletion.CASCADE, related_name = 'shops',
                                   to = 'Tick_server.Salesman')),
                ('shop_kind',
                 models.ForeignKey(null = True, on_delete = django.db.models.deletion.CASCADE, related_name = 'shops',
                                   to = 'Tick_server.ShopKind')),
            ],
        ),
        migrations.AddField(
            model_name='salesman',
            name='user',
            field = models.OneToOneField(on_delete = django.db.models.deletion.CASCADE, related_name = 'salesman',
                                         to = settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name = 'poll',
            name = 'shop',
            field = models.ForeignKey(on_delete = django.db.models.deletion.CASCADE, related_name = 'polls',
                                      to = 'Tick_server.Shop'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name = 'poll',
            field = models.OneToOneField(on_delete = django.db.models.deletion.CASCADE, related_name = 'paragraph_poll',
                                         to = 'Tick_server.Poll'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('poll', models.OneToOneField(on_delete = django.db.models.deletion.CASCADE,
                                              related_name = 'multiple_choice_poll', to = 'Tick_server.Poll')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.IntegerField()),
                ('answer_text', models.CharField(max_length=100)),
                ('poll', models.ForeignKey(on_delete = django.db.models.deletion.CASCADE, related_name = 'options',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('multiple_choice', models.ForeignKey(on_delete = django.db.models.deletion.CASCADE,
                                                      related_name = 'multiple_choice_answers',
                                                      to = 'Tick_server.MultipleChoicePoll')),
                ('option', models.ForeignKey(on_delete = django.db.models.deletion.CASCADE, related_name = 'answers',
        ...
        migrations.AddField(
            ...
            field = models.OneToOneField(on_delete = django.db.models.deletion.CASCADE,
                                         related_name = 'linear_scale_poll', to = 'Tick_server.Poll'),
        ),
        migrations.CreateModel(
            name='Discount',
            fields=[
        ...
        migrations.AddField(
            ...
            field = models.ManyToManyField(related_name = 'customers', through = 'Tick_server.LinearScalePollAnswer',
                                           to = 'Tick_server.LinearScalePoll'),
        ),
        migrations.AddField(
            model_name='customer',
            name='multiple_choice_poll_answers',
            field = models.ManyToManyField(related_name = 'customers', through = 'Tick_server.MultipleChoiceAnswer',
                                           to = 'Tick_server.MultipleChoicePoll'),
        ),
        migrations.AddField(
            model_name='customer',
            name='paragraph_poll_answers',
            field = models.ManyToManyField(related_name = 'customers', through = 'Tick_server.ParagraphPollAnswer',
                                           to = 'Tick_server.ParagraphPoll'),
        ),
        migrations.AddField(
            model_name='customer',
            name='short_answer_poll_answers',
            field = models.ManyToManyField(related_name = 'customers', through = 'Tick_server.ShortAnswerPollAnswer',
        ...
        migrations.AddField(
            model_name='checkboxpollanswer',
            name = 'options',
            field = models.ManyToManyField(related_name = 'answers', to = 'Tick_server.CheckBoxOption'),
        ),
        migrations.AddField(
            model_name = 'checkboxpoll',
            name = 'poll',
            field = models.OneToOneField(on_delete = django.db.models.deletion.CASCADE, related_name = 'checkbox_poll',
                                         to = 'Tick_server.Poll'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50)),
                ('shop', models.ForeignKey(on_delete = django.db.models.deletion.CASCADE, related_name = 'branches',
                                           to = 'Tick_server.Shop')),
            ],
        ),
    ]
